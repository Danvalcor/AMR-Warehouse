...
def forward(leftSpeed, rightSpeed):    
    ...
    # Set PWM duty cycle for forward direction
...
if __name__ == "__main__":
    ...
    left_motor_pwm = [GPIO.PWM(pin, 100) for pin in left_motor_pins[::2]]  # Pins 0 and 2 for left motor (forward and backward)
    right_motor_pwm = [GPIO.PWM(pin, 100) for pin in right_motor_pins[::2]]  # Pins 0 and 2 for right motor (forward and backward)
    ...
    while True:
        ...
        #linesROI = imagen #Pruebas con imagenes
